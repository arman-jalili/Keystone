...
/**
 * Standard error response DTO returned on notification engine failures.
 *
 * <p>Follows the same error envelope pattern as other Keystone modules.
 *
 * @param code    A machine-readable error code (e.g. "CHANNEL_NOT_FOUND", "DELIVERY_FAILED")
...
public record ErrorResponse(String code, String message, List<ErrorDetail> details) {
     ...
     *
     * @param field   The field path that caused the error (e.g. "eventType")
