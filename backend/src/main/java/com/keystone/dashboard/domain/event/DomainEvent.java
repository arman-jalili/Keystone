...
/**
 * Base contract for all domain events in the Dashboard bounded context.
 *
...
public interface DomainEvent<T> {
    ...
    /**
     * The logical event type name (e.g. "HealthScoreRecalculated", "DashboardViewAccessed").
     */
    String getEventType();

    /**
     * Source context that published this event (e.g. "dashboard-engine").
     */
    String getSource();
