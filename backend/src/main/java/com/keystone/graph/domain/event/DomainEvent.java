...
/**
 * Base contract for all domain events in the Dependency Graph bounded context.
 *
...
public interface DomainEvent<T> {
    ...
    /**
     * The logical event type name (e.g. "DependencyAdded", "DownstreamImpactComputed").
     */
    String getEventType();

    /**
     * Source context that published this event (e.g. "dependency-graph").
     */
    String getSource();
