...
guardian_issue:
  ...
  file_changes:
    - "create: src/cli-orchestrator/contracts/"
    - "create: src/cli-orchestrator/contracts/dtos/"
    - "create: src/cli-orchestrator/contracts/events/"
---
...
Define and freeze all public interfaces, contracts, and schemas for the cli-orchestrator
