...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-cli-orchestrator.md"
    - "create: docs/dr-plan-cli-orchestrator.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/cli-orchestrator.md"
---

# Architecture Readiness: cli-orchestrator

## Intent

Make the cli-orchestrator module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-cli-orchestrator.md` covering:
...
### DR Plan
`docs/dr-plan-cli-orchestrator.md` covering:
