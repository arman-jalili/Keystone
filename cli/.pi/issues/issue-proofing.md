...
guardian_issue:
  ...
  canonical_references:
    - module: ".pi/architecture/modules/cli-orchestrator.md"
  ...
  file_changes:
    - "create: .pi/scripts/ci/check_cli-orchestrator_contracts.sh"
    - "create: .pi/scripts/ci/check_cli-orchestrator_coverage.sh"
    - "modify: .pi/scripts/ci/run_hardening_stages.sh"
---

# Proofing & CI Enforcement: cli-orchestrator
...
|--------|---------|----------|
| check_cli-orchestrator_contracts.sh | Validate contract implementation | .pi/scripts/ci/ |
| check_cli-orchestrator_coverage.sh | Enforce coverage thresholds | .pi/scripts/ci/ |
| stage_cli-orchestrator_proofing.sh | CI stage wrapper | .pi/scripts/ci/ |
