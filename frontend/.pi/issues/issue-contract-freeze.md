...
guardian_issue:
  ...
  file_changes:
    - "create: src/frontend-app/contracts/"
    - "create: src/frontend-app/contracts/dtos/"
    - "create: src/frontend-app/contracts/events/"
---

# Contract Freeze: frontend-app

## Intent

Define and freeze all public interfaces, contracts, and schemas for the frontend-app
