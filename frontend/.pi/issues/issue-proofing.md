...
guardian_issue:
  ...
  canonical_references:
    - module: ".pi/architecture/modules/frontend-app.md"
  ...
  file_changes:
    - "create: .pi/scripts/ci/check_frontend-app_contracts.sh"
    - "create: .pi/scripts/ci/check_frontend-app_coverage.sh"
    - "modify: .pi/scripts/ci/run_hardening_stages.sh"
---

# Proofing & CI Enforcement: frontend-app
...
|--------|---------|----------|
| check_frontend-app_contracts.sh | Validate contract implementation | .pi/scripts/ci/ |
| check_frontend-app_coverage.sh | Enforce coverage thresholds | .pi/scripts/ci/ |
| stage_frontend-app_proofing.sh | CI stage wrapper | .pi/scripts/ci/ |
...
```bash
run_stage "11" "frontend-app_proofing" \
    "${SCRIPTS_DIR}/stage_frontend-app_proofing.sh" \
    "always"
```
