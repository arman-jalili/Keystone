// Keystone Dashboard — Tailwind v4 Config
// Editorial-Monocle direction. Extends Tailwind v4's CSS-first config.
//
// Tailwind v4 uses CSS `@theme` blocks instead of JS config.
// This file is for documentation and reference. The actual theme
// should be applied via app/globals.css using @theme.
